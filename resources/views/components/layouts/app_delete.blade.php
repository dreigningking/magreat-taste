    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
                <img src="{{asset('img/logo.jpeg')}}" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">Ma'Great Taste</span>
            </a>
        </div>
        <hr class="horizontal dark mt-0">
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            @include('components.layouts.menus')
        </div>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item nav-profile dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                                <img src="{{ auth()->user()->image }}" class="icon icon-shape bg-white shadow text-center border-radius-2xl" alt="profile" />
                            </a>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        ...
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('/') }}/#menu" class="nav-link text-muted" target="_blank">Menu</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/') }}/#blog" class="nav-link text-muted" target="_blank">Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link pe-0 text-muted" target="_blank">Settings</a>
                                </li>
                            </ul>
                        </div>
                    </div>
