                            ...
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa fa-shopping-cart text-dark text-gradient text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $stats['today_orders'] }}
                                    </h5>
                                    <span class="text-white text-sm">Today's Orders</span>
                                </div>
                                <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa fa-shopping-bag text-dark text-gradient text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $stats['total_orders'] }}
                                    </h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa fa-shopping-basket text-dark text-gradient text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $stats['total_meals'] }}
                                    </h5>
                                    <span class="text-white text-sm">Total Meals</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropdown text-end mb-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                                        <i class="fa fa-cutlery text-dark text-gradient text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                    <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                        {{ $stats['total_foods'] }}
                                    </h5>
                                    <span class="text-white text-sm">Total Foods</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropstart text-end mb-6">
    ...
    <div class="row my-4">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @if($pendingOrders->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <small class="text-muted">{{ $order->delivery_type }}</small>
                                            </div>
                                        </td>
                                    ...
                                    @endforeach
                                @elseif($recentOrders && $recentOrders->count() > 0)
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100">
                <div class="card-header pb-0">
                    <h6>Branches overview (Top this week)</h6>
                </div>
                <div class="card-body p-3">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-success">{{ $branch->order_count }} orders</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
